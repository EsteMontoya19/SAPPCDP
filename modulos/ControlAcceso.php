...
class ControlAcceso
{
    function __construct()
    {
        ...
        if ($_strUsuario == "") {
            $Valida->ponerValidacion("Usuario", "Debe ingresar su nombre de usuario.");
        }
        if ($_strContrasena == "") {
            $Valida->ponerValidacion("Contrasena", "Debe ingresar su contraseña.");
        }
