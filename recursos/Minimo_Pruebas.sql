...
INSERT INTO Asistencia (ASIS_ID_SESION, ASIS_ID_INSCRIPCION, ASIS_PRESENTE) VALUES 
    ...
    INSERT INTO PREGUNTA (PREG_DESCRIPCION, PREG_ACTIVO, PREG_ORDEN, PREG_TIPO) VALUES
        ...
        ('El material de apoyo utilizado por el instructor fue de utilidad para comprender el contendo temático del curso:', 'TRUE', 3, 'Opción míltiple'),
        ('El instructor explicó con claridad el contenido del curso:', 'TRUE', 4, 'Opción míltiple'),
        ('El instructor resolvió de manera oportuna las dudas que se presentaron a lo largo del curso:', 'TRUE', 5, 'Opción míltiple'),
        ('El instructor se desempeñó adecuadamente durante del curso:', 'TRUE', 6, 'Opción míltiple'),
