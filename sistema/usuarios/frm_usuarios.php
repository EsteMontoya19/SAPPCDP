      ...
      <input type="hidden" name="numCoordinaciones" id="numCoordinaciones" value=<?php echo(sizeof($arr_coordinaciones)); ?>>
        ...
        <?php } ?>
          ...
          <div class="form-group">
            <div class="card lg-12">
              ...
              <div class="col-lg-12 form-row">
                ...
                if (isset($usuario) && $usuario->usua_id_rol == MODERADOR) {
                  ...
                  <select required='required' class="custom-select" id="intUsuarioRol" name="intUsuarioRol" <?php if (isset($_POST['CRUD']) == 1) {
                    ...
                    <option value="<?php echo $rol['rol_id_rol']; ?>"
                        <?php if (isset($usuario)) {
                            if ($usuario->usua_id_rol == $rol['rol_id_rol']) {
                                ?> selected
                            <?php }
                        }?>>
          ...
          <div id = "datosCuenta" class="form-group"                    
           <?php if (isset($usuario) && $usuario->usua_id_rol == ADMINISTRADOR) {
            ...
            <div class="card lg-12">
              ...
              <!-- Datos del Moderador -->
              <div class="col-lg-12 form-row" style="margin-top: 15px;"> 
                <?php if (isset($usuario) && $usuario->usua_id_rol == MODERADOR) { ?>
              ...
              <!-- Datos del Profesor -->
              <div class="col-lg-12 form-row" style="margin-top: 15px;">  
                <?php if (isset($usuario) && $usuario->usua_id_rol == INSTRUCTOR) { ?>
              ...
              <div class="col-lg-12 form-row" style="margin-top: 15px;">
                ...
                <?php if (isset($usuario) && ($usuario->usua_id_rol == PROFESOR )) { ?>
            ...
            <div class="col-lg-12 form-row" style="margin-top: 15px;">
                ...
                <label for="strNombramiento" class = "negritas">Nombramiento principal: *</label><br>
                       <select class="custom-select" id="nombramiento" name="nombramiento">
                            ...
                            <option value="<?php echo ($nombramiento['nomb_id_nombramiento']) ; ?>" <?php echo (isset($profesor) && $profesor->prof_id_nombramiento == $nombramiento['nomb_id_nombramiento']) ? "selected" : ""; ?>>
        ...
        <?php  //? Si es 1 significa una actualización ?>
            ...
            <input type="hidden" name="hideRol" id="hideRol" value="<?php echo $usuario->usua_id_rol; ?>">
            <?php } elseif ($_POST['CRUD'] == 0) { ?>
