        ...
        <div class="container-fluid">
            ...
            <form name = "form_constancias_personal" id="form_constancias_personal" method="POST" enctype="multipart/form-data"
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6 form-group">
                        <label for="constanciasPersonal"><b>Seleccione el archivo zip de las constancias del periodo seleccionado anteriormente: *</b></label>
                        <div class="custom-file">
                            <input type="file" id="constanciasPersonal" name="constanciasPersonal"  class="custom-file-input" accept="application/zip" required>
                            <label class="custom-file-label" for="constanciasPersonal"></label>
                        </div>
                    </div>    
