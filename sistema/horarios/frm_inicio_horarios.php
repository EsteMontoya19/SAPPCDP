        ...
        <div class="col-sm-10" style="padding:0px">
          <ol class="breadcrumb">
            <li class="breadcrumb-item active">
              <i class="fas fa-user-shield"></i>&nbsp; Horarios
            </li>
          </ol>
        </div>
        <div class="col-sm-2" align="center">
          <a href="#">
            <button id="btn-registro-horario" type="button" class="btn btn-success">
...
<script src="../sistema/horarios/horarios.js"></script>