        ...
        <div class="card-body">
          <div class="col-lg-12 form-row" style="margin-top: 10px;">
            ...
            <div class="col-12 text-center">
              ...
              <a class="d-block small" href="#" style="color:#DB9501" type="button"  data-toggle="modal" data-target="#exampleModal">Registrar Profesor</a>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="modal-dialog modal-dialog-centered  modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title col-lg-12" id="exampleModalLabel" style="background: #2E2300;color: #fff;padding: 10px">Registrar Profesor</h5>
            ...
            <div class="row">
              <div class="col-lg-12">
                <form>
                    ...
                    <h5 class="modal-title col-lg-12" id="exampleModalLabel" style="background: #2E2300;color: #fff;padding: 10px">Datos de Acceso</h5>
                      <br>
                      <div class="form-group row">
                    ...
                    <h5 class="modal-title" id="exampleModalLabel" style="background: #2E2300;color: #fff;padding: 10px">Datos de Recuperación</h5>
                      <br>
                     <div class="form-group row">
